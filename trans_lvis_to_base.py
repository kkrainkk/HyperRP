...
parser.add_argument("--json_path", default="/root/autodl-tmp/LVIS/lvis_v1_train.json")
parser.add_argument("--out_path", default="/root/autodl-tmp/LVIS/lvis_v1_train_r.json")
