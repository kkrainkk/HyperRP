...
load_from='C:/Users/86198/Downloads/yolo_world_l_clip_base_dual_vlpan_2e-3adamw_32xb16_100e_o365_goldg_train_pretrained-0e566235.pth'
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={'backbone.img_model': dict(lr_mult=0.0),
                     'neck': dict(lr_mult=10.0),     # 自定义 neck 层，学习率较高
