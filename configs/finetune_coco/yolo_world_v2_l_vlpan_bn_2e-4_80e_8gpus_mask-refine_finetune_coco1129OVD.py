...
load_from = '/root/autodl-tmp/yolo_world_v2_l_vlpan_bn_2e-4_80e_8gpus_mask-refine_finetune_coco_ep80-81c701ee.pth'
...
coco_train_dataset = dict(
    ...
    dataset=dict(
        ...
        ann_file='annotationsOVD/ovd_ins_train2017_b.json',
...
coco_val_dataset = dict(
    ...
    dataset=dict(
        type='YOLOv5CocoDataset',
        data_root='/root/autodl-tmp/COCO',
        ann_file='annotationsOVD/ovd_ins_val2017_all.json',
        data_prefix=dict(img='val2017coco/'),
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path='/root/autodl-tmp/data/texts/coco_class_texts_test.json',
...
val_evaluator = dict(
    ...
    ann_file='/root/autodl-tmp/COCO/annotationsOVD/ovd_ins_val2017_all.json',
    metric='bbox')
