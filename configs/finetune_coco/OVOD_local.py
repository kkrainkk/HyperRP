...
coco_train_dataset = dict(
    ...
    class_text_path='D:/YOLO-World-master/data/texts/coco_class_texts_base.json',
...
coco_val_dataset = dict(
    ...
    dataset=dict(
        ...
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path='D:/YOLO-World-master/data/texts/coco_class_novel.json',
...
val_evaluator = dict(
    ...
    ann_file='D:/COCO/instances_val2017_novel_mapped.json',
    metric='bbox')
